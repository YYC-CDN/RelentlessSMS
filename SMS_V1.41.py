# -*- coding: utf-8 -*-
"""
Created on Sun Jan 29 14:50:46 2023
...
#     instructions_text = Label(instruction_window, text=("<div style='font-size:20px; font-weight:bold;'>Relentless SMS</div>"
#                                                         "<ol>"
#                                                         "<li>Put in the target phone number</li>"
#                                                         "<li>Select the number of messages you want to send</li>"
#                                                         "<li>Enter the first message. The first sent message is your personal message</li>"
#                                                         "<li>Select the speed which you want the messages sent. Slow is one every 60 seconds, medium is one every 30 seconds and fast is one every 5 seconds.</li>"
#                                                         "<li>Click Send</li>"
#                                                         "</ol>"
#                                                         "<p>The first message is your personal one. After that is sent, the app will cycle through several random gibberish messages. If you send 100 messages, it will cycle through them. Each sent message will display in the window. Messages will be 160 characters or less. Toll free numbers are not allowed and the app assumes you are calling USA or Canada or any other +1 dialing country.</p>"
#                                                         "<p><i>Portions of code from <a href='https://chat.openai.com'>https://chat.openai.com</a></i></p>"
#                                                         "<p><i>Graphics from <a href='https://openai.com/dall-e-2/'>https://openai.com/dall-e-2/</a></i></p>"))
#     instructions_text.pack()
#     instructions_text.config(justify=LEFT)
#     instructions_text.config(font=("Arial", 14))
#     instruction_window.geometry("500x500")
#     instruction_window.config(bg='white')
#     instruction_text.config(wraplength=300)
