# -*- coding: utf-8 -*-
"""
Created on Sat Jan 28 23:24:52 2023
...
def send_sms():
    ...
    message_entry.delete("1.0", END) #clear the message_entry widget before each message sent
    ...
    for i in range(messages_to_send):
        message_entry.insert(END, gibberish_messages[i % len(gibberish_messages)]) #insert the current gibberish message
        message = message_entry.get("1.0", END)
