# -*- coding: utf-8 -*-
"""
Created on Fri Jan 27 23:08:17 2023
...
def send_sms():
    ...
    if len(message) == 0:
        # Generate 160 characters of English gibberish
        message = faker.paragraph(nb_sentences=1, variable_nb_sentences=True, ext_word_list=None)[:160]
