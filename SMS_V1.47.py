# -*- coding: utf-8 -*-
"""
Created on Fri Feb  3 13:43:41 2023
...
try:
    logo = PhotoImage(file="C:\\logo1.png")
...
def open_instructions():
    ...
    instructions_text.insert(INSERT, "The logo is located on the C: drive. It's called logo.png. It's a simple circle logo generated in OpenAI with a transparent background. If there is no logo there, the script will ignore it and continue.\n\n")
    ...
    instruction_window.geometry("500x380")
...
# Check Quota https://textbelt.com/quota/23011806a32dfceb057bc4ba2488fc5032ad1322ZvLZ8G74K0w6fFf4Uo5AwMv4s