# -*- coding: utf-8 -*-
"""
Created on Sat Jan 28 14:07:40 2023
...
phone_number_label.grid(row=0, column=0, padx=5, pady=10, sticky=W)
...
number_of_messages_label.grid(row=1, column=0, padx=5, pady=10, sticky=W)
number_of_messages = IntVar()
number_of_messages_menu = OptionMenu(root, number_of_messages, *range(1,101))
number_of_messages_menu.grid(row=1, column=1, padx=5, pady=10)

# Message label and entry
message_label = Label(root, text="Message:")
message_label.grid(row=2, column=0, padx=5, pady=10, sticky="W")

message_entry = Text(root, height=5, width=45)
message_entry.grid(row=2, column=1, padx=5, pady=5, columnspan=2)
...
test_label.grid(row=7, column=0, padx=5, pady=0)
