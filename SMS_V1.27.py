# -*- coding: utf-8 -*-
"""
Created on Sat Jan 28 13:33:45 2023
...
number_of_messages_menu.grid(row=2, column=2, padx=10, pady=10)

# number_of_messages = IntVar()
# number_of_messages_menu = OptionMenu(root, number_of_messages, *range(1,101))
# number_of_messages_menu.place(relx = 0.4, rely = 0.2, anchor = 'w')
...
send_button.place(relx = 0.4, rely = 0.7, anchor = 'w')

close_button = Button(root, text="Close", command=root.destroy)
close_button.place(relx = 0.5, rely = 0.7, anchor = 'w')

test_label = Label(root, text="RESTRICTED INTERNAL CLASSIFIED USE ONLY", fg='gray')
test_label.place(relx = 0.5, rely = 0.9, anchor = 'center')
...
#     progress_bar["value"] = 0
#     for i in range(messages_to_send):
#         # Send the SMS using requests.post() here
#         # ...
#         # increment the progress bar value
#         progress_bar["value"] += 1
#         progress_bar.update()
