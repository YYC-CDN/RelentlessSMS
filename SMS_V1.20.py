# -*- coding: utf-8 -*-
"""
Created on Sat Jan 28 00:05:53 2023
...
#Create a label for the phone number entry

phone_number_label = Label(root, text="Phone Number:")
phone_number_label.grid(row=0, column=0)
#Create an entry for the email address
...
submit_button = Button(root, text="Submit", command=send_sms)
