# -*- coding: utf-8 -*-
"""
Created on Fri Jan 27 16:23:05 2023
...
return False
return True
#'Helper function to send SMS using the smsmode.com API
...
phone_entry.pack()
#'SMS message entry field

message_label = tk.Label(root, text = "SMS Message:")
message_label.pack()
...
stop_button = tk.Button(root, text = "Close", command = on_stop)
stop_button.pack()