# -*- coding: utf-8 -*-
"""
Created on Fri Jan 27 22:43:16 2023
...
test_label = Label(root, text="This is test software only", fg='gray')
test_label.grid(row=5, column=1, padx=10, pady=10)


# To limit the number of characters in the message entry widget, you can use the following code:
def on_entry_change(event):
    if len(message_entry.get("1.0", "end-1c")) > 160:
        message_entry.delete("end-1c")
message_entry.bind("<Key>", on_entry_change)
