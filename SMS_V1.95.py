# -*- coding: utf-8 -*-
"""
Created on Sun Feb 19 19:46:06 2023
...
#
#
# PURPOSE: The purpose of this script is to simply annoy. 
#
#
#
#
...
# =================  PHONE ENTRY =============================================
phone_number_entry = Entry(root, font=("Segoe UI", 10), width=20)
...
provider_dropdown = OptionMenu(root, provider_var, "T-Mobile", "AT&T", command=lambda x: set_provider({
    "T-Mobile": "@tmomail.net",
    "AT&T": "@txt.att.net"
}[x]))
provider_dropdown.grid(row=0, column=1, padx=100, pady=3, sticky=W)
